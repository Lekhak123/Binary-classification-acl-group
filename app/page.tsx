            ...
            ?.bestThumbnail
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions justify-center">
                        <button onClick={(e) => handleSkip(youtubeJsonData[0]
                            ?.id)} className="btn btn-primary">Skip</button>
                        <button onClick={(e) => handleGood(youtubeJsonData[0])} className="btn btn-secondary">Good</button>
                        <button onClick={(e) => handleBad(youtubeJsonData[0])} className="btn btn-accent">Bad</button>
                    </div>
                </div>
            </div>
        </main>
